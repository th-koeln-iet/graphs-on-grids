...
def create_graph_dataset(num_graphs, num_features, num_nodes, create_edge_features=True) -> StaticGraphDataset:
    ...
    graphs = GraphList(node_feature_names=feature_names, num_nodes=num_nodes, edge_feature_names=feature_names,
                       num_edges=len(edge_list)) if create_edge_features else GraphList(
        node_feature_names=feature_names, num_nodes=num_nodes)
    ...
    for i in range(num_graphs):
        ...
        if create_edge_features:
            ...
            graphs.append(
                Graph(node_features=node_features, node_feature_names=feature_names, edge_features=edge_features,
                      edge_feature_names=feature_names))
        else:
            graphs.append(Graph(node_features=node_features, node_feature_names=feature_names))
